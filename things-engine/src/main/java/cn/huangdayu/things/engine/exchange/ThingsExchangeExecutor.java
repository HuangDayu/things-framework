package cn.huangdayu.things.engine.exchange;
...
public class ThingsExchangeExecutor implements Handler {
    ...
    private void init() {
        ...
        thingsObserverEngine.registerObserver(ThingsCacheMessageEvent.class, event -> doHandler(event.getJsonThingsMessage()));
    }
    ...
    public JsonThingsMessage doHandler(JsonThingsMessage jsonThingsMessage) {
        ...
        // TODO 应当根据消息的QOS决定消息是否需要缓存处理，或者直接返回错误
