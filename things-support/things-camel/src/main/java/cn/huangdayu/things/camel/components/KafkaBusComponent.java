 ...
 */
@Getter
public class KafkaBusComponent extends AbstractCamelComponent implements ThingsBusComponent {

    public KafkaBusComponent(CamelContext camelContext, ProducerTemplate producerTemplate) {
